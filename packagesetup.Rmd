...
obs.cond.2d.sfs <- get_two_dimensionalSFSDT(dataObject = example.data,n1Min = 1,n1Max = 29,monomorphic = FALSE,fixedDerived = FALSE)
obs.cond.2d.sfsL <- get_two_dimensionalSFSlist(dataObject = example.data,n1Min = 1,n1Max = 29,monomorphic = FALSE,fixedDerived = FALSE)
