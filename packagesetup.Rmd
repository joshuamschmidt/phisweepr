...
java -Xmx6G -jar ${msms} 50 1 -t 8000 -r 8000 20000001 -SAA 1000 -SaA 500 -SF 0 0.7 -N 10000 -seed 101010 -Smark -oFP 0.00000000 > ${out}/msms.selection.50chr.s05.b07.txt
...
example.data <- get.simulated.data("/Users/joshuaschmidtProjects/phisweepr/inst/extdata/msms.selection.50chr.s05.b07.txt", "msms")
```
...
# plot(nkMatrix[20,],pch=19,cex=0.5,ylim=c(0,0.5))
# points(nkMatrixdp[20,],pch=19,cex=0.5,col='red')
# points(nkMatrixds[20,],pch=19,cex=0.5,col='seagreen')
# calculate phiN
...
getPhiS <- function(dataObject, nkMatrix, n1range, alphaDres=alphaDres,beta=1){
  ...
  phiSTable <- makePhiSTable(nSam = nSam,testN1s = n1range, ptable = nkMatrixds, alphad = 10^log10_alphad,1)
...
mc_maxLRatio_table <- mcmapply(ml_phir,core_snps_idxs, MoreArgs = list(dataObject = dataObject,phiNTable = obsPhiNTable,phiSTable = phiSTable,alpha_levels=alpha_levels,pEscapeLim = pEscapeLim,method="bruteforce",log10_alphad.vec = log10_alphad,low_alpha=low_alpha,monomorphic = monomorphic,minN1 = n1range[1]))
