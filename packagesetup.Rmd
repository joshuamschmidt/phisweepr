...
data.table(matrix(unlist(mc_maxLRatio_table), nrow=length(mc_maxLRatio_table), byrow=T))[,plot(V6,V5)]
data.table(matrix(unlist(mc_maxLRatio_table), nrow=length(mc_maxLRatio_table), byrow=T))[V6==15e6]
```
