...
pEscapeLim = 0.9 # 90% pescape of a single lineage
alphad_max_d <- maxd_byAlpha(alphaParVec=alpha_levels,pEscapeLim = 0.9)
...
k1 <- factor(diff(dataObject$genotypes[rowslice,core_window_idxs]@p),levels = 0:n1)[-core_idx_in_window]
k2 <- factor(diff(dataObject$genotypes[-rowslice,core_window_idxs]@p),levels = 0:n2)[-core_idx_in_window]
